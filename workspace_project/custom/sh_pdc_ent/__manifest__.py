# Copyright (C) Softhealer Technologies.
{
    ...
    "category": "Accounting",
    "license": "OPL-1",
    "summary": "Post Dated Cheque Management, Manage Post Dated Cheque App, View Vendor Invoice PDC , List Of Customer PDC Payment, Track Client PDC Process, Register Vendor Post Dated Cheque Module, Print VendorPDC Report, Print Client PDC Report Post Dated Cheque Management Customer cheque Management Vendor cheque Management Incoming cheque Management Outgoing Cheque Management Odoo.",
